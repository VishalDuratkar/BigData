...
/*
hadoop jar /home/hduser/workspace/finalPro.jar /user/hive/warehouse/project.db/h1b_final/* /project/project9
hadoop fs -cat /project/project9/*

Which are the employers along with the number of petitions 
...
public class Program9 
{
	public static class myMapper extends Mapper<LongWritable, Text, Text, Text>
	{
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			String employer_name = arr[2].trim();
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException
	{
		...
		job.setJarByClass(Program9.class);
