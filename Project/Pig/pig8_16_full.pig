...
year16 = filter data_extract by year == 2016 and shift=='Y';
groupByJob16 = GROUP year16 by job;
avg_cal16 = Foreach groupByJob16 generate group, AVG(year16.wage) as Average;
fullTimeOrdered16 = Order avg_cal16 by Average desc;
Store fullTimeOrdered16 into '/project/project8/2016/fullTime' using PigStorage();
