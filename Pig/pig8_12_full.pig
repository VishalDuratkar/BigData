...
year12 = filter data_extract by year == 2012 and shift=='Y';
groupByJob12 = GROUP year12 by job;
avg_cal12 = Foreach groupByJob12 generate group, AVG(year12.wage) as Average;
fullTimeOrdered12 = Order avg_cal12 by Average desc;
Store fullTimeOrdered12 into '/project/project8/2012/fullTime' using PigStorage();
