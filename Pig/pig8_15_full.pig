...
year15 = filter data_extract by year == 2015 and shift=='Y';
groupByJob15 = GROUP year15 by job;
avg_cal15 = Foreach groupByJob15 generate group, AVG(year15.wage) as Average;
fullTimeOrdered15 = Order avg_cal15 by Average desc;
Store fullTimeOrdered15 into '/project/project8/2015/fullTime' using PigStorage();
