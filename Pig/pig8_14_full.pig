...
year14 = filter data_extract by year == 2014 and shift=='Y';
groupByJob14 = GROUP year14 by job;
avg_cal14 = Foreach groupByJob14 generate group, AVG(year14.wage) as Average;
fullTimeOrdered14 = Order avg_cal14 by Average desc;
Store fullTimeOrdered14 into '/project/project8/2014/fullTime' using PigStorage();
